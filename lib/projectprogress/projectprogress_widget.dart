...
class ProjectprogressWidget extends StatefulWidget {
  ...
  @override
  State<ProjectprogressWidget> createState() => _ProjectprogressWidgetState();
}

class _ProjectprogressWidgetState extends State<ProjectprogressWidget> {
  late ProjectprogressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectprogressModel());
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              '5rzhu45l' /* Project Progress Overview */,
            ),
