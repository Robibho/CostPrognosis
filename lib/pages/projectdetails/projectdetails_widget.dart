  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CostprojectRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CostprojectRecord> projectdetailsCostprojectRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final projectdetailsCostprojectRecord =
            projectdetailsCostprojectRecordList.isNotEmpty
                ? projectdetailsCostprojectRecordList.first
                : null;
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    projectdetailsCostprojectRecord!.photoUrl,
                                    width: double.infinity,
